...
@Component({
    ...
    template: `
        ...
        >
            ...
            <p>
                A set of custom designed components that you can extend and build on. BSPK makes following the Bespoke
                Design System easier than ever. Open Source. Open Code.
            </p>
        </section>
    `,
    styles: [
