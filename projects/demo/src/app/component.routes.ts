...
import { AccordionRouteComponent, AvatarRouteComponent, BadgeRouteComponent, ButtonRouteComponent, CardRouteComponent, DialogRouteComponent, DrawerRouteComponent, InputRouteComponent, MenuRouteComponent, ModalRouteComponent, TooltipRouteComponent, TxtRouteComponent } from './routes/components';
...
export const componentItems: NavRoute[] = [
  ...
  { path: 'menu', component: MenuRouteComponent, title: 'Menu' },
