...
@Component({
    selector: 'icon-sentiment-very-dissatisfied-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="SentimentVeryDissatisfiedFill"
        data-filled="true"
        data-type="material"
