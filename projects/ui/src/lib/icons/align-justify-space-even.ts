...
@Component({
    selector: 'icon-align-justify-space-even',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AlignJustifySpaceEven"
        data-type="material"
