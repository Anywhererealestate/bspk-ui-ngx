...
@Component({
    selector: 'icon-upcoming-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="UpcomingFill"
        data-filled="true"
        data-type="material"
