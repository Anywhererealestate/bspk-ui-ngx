...
@Component({
    selector: 'icon-wifi-calling',
    template: `<svg
        [style.width]="width"
        data-bspk-name="WifiCalling"
        data-type="material"
