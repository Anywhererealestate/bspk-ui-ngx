...
@Component({
    selector: 'icon-flag-lithuania',
    template: `<svg
        [style.width]="width"
        data-bspk-name="FlagLithuania"
        data-type="country"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
    >
        <g clip-path="url(#SvgFlagLithuania__a)">
        ...
        <defs>
            <clipPath id="SvgFlagLithuania__a">
...
export class IconFlagLithuania {
    @Input() width?: string;
}
