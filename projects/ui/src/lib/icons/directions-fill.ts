...
@Component({
    selector: 'icon-directions-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DirectionsFill"
        data-filled="true"
        data-type="material"
