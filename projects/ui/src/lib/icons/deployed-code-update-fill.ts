...
@Component({
    selector: 'icon-deployed-code-update-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DeployedCodeUpdateFill"
        data-filled="true"
        data-type="material"
