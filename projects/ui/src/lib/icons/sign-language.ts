...
@Component({
    selector: 'icon-sign-language',
    template: `<svg
        [style.width]="width"
        data-bspk-name="SignLanguage"
        data-type="material"
