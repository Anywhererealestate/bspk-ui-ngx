...
@Component({
    selector: 'icon-thermostat-auto',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ThermostatAuto"
        data-type="material"
