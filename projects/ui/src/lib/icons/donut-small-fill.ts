...
@Component({
    selector: 'icon-donut-small-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DonutSmallFill"
        data-filled="true"
        data-type="material"
