...
@Component({
    selector: 'icon-forward-to-inbox-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ForwardToInboxFill"
        data-filled="true"
        data-type="material"
