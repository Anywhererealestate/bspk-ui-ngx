...
@Component({
    selector: 'icon-unsubscribe',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Unsubscribe"
        data-type="material"
