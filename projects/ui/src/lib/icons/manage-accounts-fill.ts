...
@Component({
    selector: 'icon-manage-accounts-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ManageAccountsFill"
        data-filled="true"
        data-type="material"
