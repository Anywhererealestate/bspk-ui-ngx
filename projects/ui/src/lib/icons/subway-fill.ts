...
@Component({
    selector: 'icon-subway-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="SubwayFill"
        data-filled="true"
        data-type="material"
