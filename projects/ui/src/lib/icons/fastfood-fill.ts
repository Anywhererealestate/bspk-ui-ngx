...
@Component({
    selector: 'icon-fastfood-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="FastfoodFill"
        data-filled="true"
        data-type="material"
