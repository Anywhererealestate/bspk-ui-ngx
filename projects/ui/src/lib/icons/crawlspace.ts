...
@Component({
    selector: 'icon-crawlspace',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Crawlspace"
        data-type="anywhere"
