...
@Component({
    selector: 'icon-ramp-left',
    template: `<svg
        [style.width]="width"
        data-bspk-name="RampLeft"
        data-type="material"
