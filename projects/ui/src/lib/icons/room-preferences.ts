...
@Component({
    selector: 'icon-room-preferences',
    template: `<svg
        [style.width]="width"
        data-bspk-name="RoomPreferences"
        data-type="material"
