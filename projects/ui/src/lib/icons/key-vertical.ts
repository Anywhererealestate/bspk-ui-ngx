...
@Component({
    selector: 'icon-key-vertical',
    template: `<svg
        [style.width]="width"
        data-bspk-name="KeyVertical"
        data-type="material"
