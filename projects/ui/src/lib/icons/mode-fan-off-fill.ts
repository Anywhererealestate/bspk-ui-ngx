...
@Component({
    selector: 'icon-mode-fan-off-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ModeFanOffFill"
        data-filled="true"
        data-type="material"
