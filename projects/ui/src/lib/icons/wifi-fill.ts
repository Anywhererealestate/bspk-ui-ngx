...
@Component({
    selector: 'icon-wifi-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="WifiFill"
        data-filled="true"
        data-type="material"
