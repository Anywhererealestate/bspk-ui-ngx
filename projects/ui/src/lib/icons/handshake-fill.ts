...
@Component({
    selector: 'icon-handshake-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="HandshakeFill"
        data-filled="true"
        data-type="material"
