...
@Component({
    selector: 'icon-box-add',
    template: `<svg
        [style.width]="width"
        data-bspk-name="BoxAdd"
        data-type="material"
