...
@Component({
    selector: 'icon-align-justify-center',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AlignJustifyCenter"
        data-type="material"
