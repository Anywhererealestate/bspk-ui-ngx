...
@Component({
    selector: 'icon-stress-management',
    template: `<svg
        [style.width]="width"
        data-bspk-name="StressManagement"
        data-type="material"
