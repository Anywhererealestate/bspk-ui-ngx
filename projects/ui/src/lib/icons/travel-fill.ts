...
@Component({
    selector: 'icon-travel-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="TravelFill"
        data-filled="true"
        data-type="material"
