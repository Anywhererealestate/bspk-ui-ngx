...
@Component({
    selector: 'icon-wifi-home-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="WifiHomeFill"
        data-filled="true"
        data-type="material"
