...
@Component({
    selector: 'icon-format-line-spacing',
    template: `<svg
        [style.width]="width"
        data-bspk-name="FormatLineSpacing"
        data-type="material"
