...
@Component({
    selector: 'icon-pin-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="PinFill"
        data-filled="true"
        data-type="material"
