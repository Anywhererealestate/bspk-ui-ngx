...
@Component({
    selector: 'icon-deployed-code-account',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DeployedCodeAccount"
        data-type="material"
