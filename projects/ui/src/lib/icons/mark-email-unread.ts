...
@Component({
    selector: 'icon-mark-email-unread',
    template: `<svg
        [style.width]="width"
        data-bspk-name="MarkEmailUnread"
        data-type="material"
