...
@Component({
    selector: 'icon-vertical-align-center',
    template: `<svg
        [style.width]="width"
        data-bspk-name="VerticalAlignCenter"
        data-type="material"
