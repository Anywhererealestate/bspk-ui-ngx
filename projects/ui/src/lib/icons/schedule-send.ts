...
@Component({
    selector: 'icon-schedule-send',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ScheduleSend"
        data-type="material"
