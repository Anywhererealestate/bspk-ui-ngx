...
@Component({
    selector: 'icon-stress-management-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="StressManagementFill"
        data-filled="true"
        data-type="material"
