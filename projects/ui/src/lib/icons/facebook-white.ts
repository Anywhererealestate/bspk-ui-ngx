...
@Component({
    selector: 'icon-facebook-white',
    template: `<svg
        [style.width]="width"
        data-bspk-name="FacebookWhite"
        data-type="brand"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
    >
        <g clip-path="url(#SvgFacebookWhite__a)">
            <path
        ...
        <defs>
            <clipPath id="SvgFacebookWhite__a">
...
export class IconFacebookWhite {
    @Input() width?: string;
}
