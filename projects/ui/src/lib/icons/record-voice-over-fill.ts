...
@Component({
    selector: 'icon-record-voice-over-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="RecordVoiceOverFill"
        data-filled="true"
        data-type="material"
