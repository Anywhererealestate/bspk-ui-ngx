...
@Component({
    selector: 'icon-move-to-inbox-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="MoveToInboxFill"
        data-filled="true"
        data-type="material"
