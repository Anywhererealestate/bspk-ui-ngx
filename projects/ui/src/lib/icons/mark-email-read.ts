...
@Component({
    selector: 'icon-mark-email-read',
    template: `<svg
        [style.width]="width"
        data-bspk-name="MarkEmailRead"
        data-type="material"
