...
@Component({
    selector: 'icon-airport-shuttle-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AirportShuttleFill"
        data-filled="true"
        data-type="material"
