...
@Component({
    selector: 'icon-fork-right',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ForkRight"
        data-type="material"
