...
@Component({
    selector: 'icon-content-paste-off',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ContentPasteOff"
        data-type="material"
