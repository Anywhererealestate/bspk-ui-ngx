...
@Component({
    selector: 'icon-kebab-dining-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="KebabDiningFill"
        data-filled="true"
        data-type="material"
