...
@Component({
    selector: 'icon-home-work-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="HomeWorkFill"
        data-filled="true"
        data-type="material"
