...
@Component({
    selector: 'icon-unsubscribe-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="UnsubscribeFill"
        data-filled="true"
        data-type="material"
