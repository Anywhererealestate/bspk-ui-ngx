...
@Component({
    selector: 'icon-wifi-home',
    template: `<svg
        [style.width]="width"
        data-bspk-name="WifiHome"
        data-type="material"
