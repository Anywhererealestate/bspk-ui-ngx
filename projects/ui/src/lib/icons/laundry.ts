...
@Component({
    selector: 'icon-laundry',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Laundry"
        data-type="material"
