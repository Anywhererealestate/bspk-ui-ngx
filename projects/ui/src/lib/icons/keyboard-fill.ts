...
@Component({
    selector: 'icon-keyboard-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="KeyboardFill"
        data-filled="true"
        data-type="material"
