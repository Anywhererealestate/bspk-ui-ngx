...
@Component({
    selector: 'icon-note-add-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="NoteAddFill"
        data-filled="true"
        data-type="material"
