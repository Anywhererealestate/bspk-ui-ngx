...
@Component({
    selector: 'icon-emoji-language-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="EmojiLanguageFill"
        data-filled="true"
        data-type="material"
