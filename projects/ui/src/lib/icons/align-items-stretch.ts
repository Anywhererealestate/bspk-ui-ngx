...
@Component({
    selector: 'icon-align-items-stretch',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AlignItemsStretch"
        data-type="material"
