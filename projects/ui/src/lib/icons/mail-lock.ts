...
@Component({
    selector: 'icon-mail-lock',
    template: `<svg
        [style.width]="width"
        data-bspk-name="MailLock"
        data-type="material"
