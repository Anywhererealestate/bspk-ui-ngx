...
@Component({
    selector: 'icon-add-aphoto-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AddAPhotoFill"
        data-filled="true"
        data-type="material"
