...
@Component({
    selector: 'icon-taxi-alert',
    template: `<svg
        [style.width]="width"
        data-bspk-name="TaxiAlert"
        data-type="material"
