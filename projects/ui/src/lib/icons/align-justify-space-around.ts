...
@Component({
    selector: 'icon-align-justify-space-around',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AlignJustifySpaceAround"
        data-type="material"
