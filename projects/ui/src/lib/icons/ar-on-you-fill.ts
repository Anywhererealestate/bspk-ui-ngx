...
@Component({
    selector: 'icon-ar-on-you-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ArOnYouFill"
        data-filled="true"
        data-type="material"
