...
@Component({
    selector: 'icon-notifications-off-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="NotificationsOffFill"
        data-filled="true"
        data-type="material"
