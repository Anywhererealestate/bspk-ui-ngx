...
@Component({
    selector: 'icon-outbox',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Outbox"
        data-type="material"
