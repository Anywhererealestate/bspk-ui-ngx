...
@Component({
    selector: 'icon-view-module-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ViewModuleFill"
        data-filled="true"
        data-type="material"
