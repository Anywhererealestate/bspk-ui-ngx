...
@Component({
    selector: 'icon-diversity1fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Diversity1Fill"
        data-filled="true"
        data-type="material"
