...
@Component({
    selector: 'icon-donut-small',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DonutSmall"
        data-type="material"
