...
@Component({
    selector: 'icon-align-justify-flex-start',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AlignJustifyFlexStart"
        data-type="material"
