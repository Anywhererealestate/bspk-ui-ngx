...
@Component({
    selector: 'icon-heat-pump',
    template: `<svg
        [style.width]="width"
        data-bspk-name="HeatPump"
        data-type="material"
