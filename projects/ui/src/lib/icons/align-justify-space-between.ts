...
@Component({
    selector: 'icon-align-justify-space-between',
    template: `<svg
        [style.width]="width"
        data-bspk-name="AlignJustifySpaceBetween"
        data-type="material"
