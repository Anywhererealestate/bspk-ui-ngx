...
@Component({
    selector: 'icon-sentiment-dissatisfied-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="SentimentDissatisfiedFill"
        data-filled="true"
        data-type="material"
