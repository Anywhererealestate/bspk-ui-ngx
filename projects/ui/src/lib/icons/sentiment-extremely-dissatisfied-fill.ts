...
@Component({
    selector: 'icon-sentiment-extremely-dissatisfied-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="SentimentExtremelyDissatisfiedFill"
        data-filled="true"
        data-type="material"
...
export class IconSentimentExtremelyDissatisfiedFill {
    @Input() width?: string;
}
