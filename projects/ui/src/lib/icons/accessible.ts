...
@Component({
    selector: 'icon-accessible',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Accessible"
        data-type="material"
