...
@Component({
    selector: 'icon-move-location-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="MoveLocationFill"
        data-filled="true"
        data-type="material"
