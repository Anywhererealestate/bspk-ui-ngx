...
@Component({
    selector: 'icon-schedule-send-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ScheduleSendFill"
        data-filled="true"
        data-type="material"
