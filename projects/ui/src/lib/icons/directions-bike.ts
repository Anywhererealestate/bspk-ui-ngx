...
@Component({
    selector: 'icon-directions-bike',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DirectionsBike"
        data-type="material"
