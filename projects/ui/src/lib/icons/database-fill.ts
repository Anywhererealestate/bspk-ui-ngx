...
@Component({
    selector: 'icon-database-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="DatabaseFill"
        data-filled="true"
        data-type="material"
