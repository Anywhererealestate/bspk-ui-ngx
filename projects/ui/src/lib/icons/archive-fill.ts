...
@Component({
    selector: 'icon-archive-fill',
    template: `<svg
        [style.width]="width"
        data-bspk-name="ArchiveFill"
        data-filled="true"
        data-type="material"
