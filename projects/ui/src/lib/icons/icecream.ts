...
@Component({
    selector: 'icon-icecream',
    template: `<svg
        [style.width]="width"
        data-bspk-name="Icecream"
        data-type="material"
