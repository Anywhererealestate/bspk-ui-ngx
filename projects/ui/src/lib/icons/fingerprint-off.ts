...
@Component({
    selector: 'icon-fingerprint-off',
    template: `<svg
        [style.width]="width"
        data-bspk-name="FingerprintOff"
        data-type="material"
