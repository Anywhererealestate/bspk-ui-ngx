...
export type PageControlVariant = 'flat' | 'floating';
 ...
 *
 * ```html
 * <ui-page-control [currentPage]="2" [numPages]="5" variant="floating" />
 * ```
 *
 * @name PageControl
 * @phase Dev
            ...
            <span
                ...
                @for (dot of dots(); track dot.pageIndex) {
                    <span
                        ...
                        [attr.data-active]="dot.pageIndex + 1 === current() ? '' : null"></span>
                }
            </span>
        }
    `,
