...
@Component({
    ...
    template: `
        <h4>Default</h4>
        <ui-password-field [(value)]="value" name="password" label="Password" helperText="Enter a secure password." />
        ...
        <h4>With error</h4>
        <ui-password-field name="password-error" label="Password" errorMessage="Password is required." />
    `,
})
