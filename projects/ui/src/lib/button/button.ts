...
export class Button implements OnInit {
   ...
   * When label isn't showing it is used in a tooltip and as the aria-label prop.
   *
  ...
  @Input() class?: string;
  /**
   * Custom content template to override default button content.
   * Not recommended - use for special cases only.
   */
