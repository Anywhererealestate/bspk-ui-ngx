    ...
    template: `
        ...
        <div style="width: 360px; display: grid; gap: 16px">
            <ui-list-item
                ...
                <span data-leading>
                    <ui-avatar [showIcon]="false" size="small" name="File 13 Avatar" color="blue"></ui-avatar>
                </span>
                <span data-trailing>
                    <ui-button
                        variant="tertiary"
        ...
        <div style="width: 360px; display: grid; gap: 16px">
            <ui-list-item
                ...
                <span data-leading>
                    <ui-avatar [showIcon]="false" size="small" name="Project Report Avatar" color="green"></ui-avatar>
                </span>
                <span data-trailing>
                    <icon-more-vert />
                </span>
